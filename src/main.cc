...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    if (cache->roi_access[cpu][0]|| true)
    {
        cout << cache->NAME;
    ...
    if (cache->roi_access[cpu][1]|| true)
    {
        cout << cache->NAME;
    ...
    if (cache->roi_access[cpu][2]|| true)
    {
        cout << cache->NAME;
    ...
    if (cache->roi_access[cpu][3]|| true)
    {
        cout << cache->NAME;
    ...
    if (cache->roi_access[cpu][4]|| true)
    {
        cout << cache->NAME;
    ...
    if (cache->roi_access[cpu][5]|| true)
    {
        cout << cache->NAME;
    ...
    if (cache->roi_access[cpu][6]|| true)
    {
        cout << cache->NAME;
...
// IPCP:
    ...
    for (uint32_t i = 0; i < NUM_CPUS; i++)
    {
        ...
        cout << "Percentage of speculative instructions: " << (float)(inst_total_loads - inst_non_spec_loads) / inst_total_loads << endl;
    }
